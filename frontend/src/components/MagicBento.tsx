...
const cardData: BentoCardProps[] = [
  {
    color: '#060010',
    title: 'Live Auctions',
    description: 'Real-time bidding on premium collectibles',
    label: 'Active'
  },
  {
    color: '#060010',
    title: 'Retail Collection',
    description: 'Curated luxury items and accessories',
    label: 'Shop'
  },
  {
    color: '#060010',
        ...
        {`
          ...
          @keyframes livePulse {
            ...
            50% {
              ...
              text-shadow: 0 0 15px rgba(239, 68, 68, 1), 0 0 25px rgba(239, 68, 68, 0.8), 0 0 35px rgba(239, 68, 68, 0.6);
            }
            100% {
              opacity: 1;
              transform: scale(1);
              ...
              return (
                ...
                >
                  ...
                  <div className="card__content flex flex-col relative text-white">
                    <h3 className={`card__title font-normal text-base m-0 mb-1 text-center ${textAutoHide ? 'text-clamp-1' : ''}`}>
                      {card.title === 'Live Auctions' ? (
                        <span 
                          className="text-red-500 font-semibold live-auction-text block"
                          style={{
